...
const categories = Object.fromEntries(['overall', 'love', 'money', 'career', 'health'].map((key) => [key, { label: key, score: 80, summary: '오늘의 흐름을 차분히 살피면 좋은 기회를 만날 수 있어요.' }]));
const fortune = { date: '2026-08-05', overallScore: 80, headline: '자신의 빛을 감추지 않아도 되는 날', categories, lucky: { color: '라벤더', number: 7, time: '14:00', advice: '마음을 믿으세요.' } } as DailyFortune;
const transits = { date: fortune.date, chart, aspects: [] } as TransitData;
